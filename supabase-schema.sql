...
create table if not exists public."sheylaspro-sitecontent" (
  key text primary key, value text not null default '', updated_at timestamptz not null default now()
);
create table if not exists public."sheylaspro-staffprofiles" (
...
alter table public."sheylaspro-sitecontent" enable row level security;
alter table public."sheylaspro-staffprofiles" enable row level security;

do $$ declare t text; begin
  foreach t in array array['sheylaspro-appointments','sheylaspro-clients','sheylaspro-reviews','sheylaspro-services','sheylaspro-estimates','sheylaspro-team','sheylaspro-sitecontent','sheylaspro-staffprofiles'] loop
...
drop policy if exists "sheylaspro public content" on public."sheylaspro-sitecontent";
create policy "sheylaspro public content" on public."sheylaspro-sitecontent" for select to anon using (true);
...
insert into public."sheylaspro-sitecontent" (key,value) values
